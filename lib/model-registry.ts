...
export const hardwareProfiles: HardwareProfile[] = [
  ...
  { id: "gemma-4-12b", familyId: "gemma-4", variant: "12B", paramBillions: 12, isMoE: false, useCase: { general: 8, code: 7, longContext: 9, math: 7 }, ollamaTag: "gemma4:12b", hfPath: "google/gemma-4-12B-it-qat-q4_0-gguf", quants: [{ name: "Q4_0 (QAT)", qualityBucket: "high", memoryGb: 7, path: "gemma-4-12b-it-qat-q4_0.gguf" }] },
  ...
  { id: "gemma-4-26b-a4b", familyId: "gemma-4", variant: "26B-A4B MoE", paramBillions: 26, activeParamBillions: 4, isMoE: true, useCase: { general: 9, code: 7, longContext: 9, math: 8 }, ollamaTag: "gemma4:26b", hfPath: "google/gemma-4-26B-A4B-it-qat-q4_0-gguf", quants: [{ name: "Q4_0 (QAT)", qualityBucket: "high", memoryGb: 15, path: "gemma-4-26B_q4_0-it.gguf" }] },
  { id: "gemma-4-31b", familyId: "gemma-4", variant: "31B dense", paramBillions: 31, isMoE: false, useCase: { general: 9, code: 8, longContext: 9, math: 8 }, ollamaTag: "gemma4:31b", hfPath: "google/gemma-4-31B-it-qat-q4_0-gguf", quants: [{ name: "Q4_0 (QAT)", qualityBucket: "high", memoryGb: 18, path: "gemma-4-31B_q4_0-it.gguf" }] },
