...
export const hardwareProfiles: HardwareProfile[] = [
  { id: "minicpm5-1b", familyId: "minicpm5", variant: "1B", paramBillions: 1, isMoE: false, useCase: { general: 5, code: 4, longContext: 5, math: 4 }, ollamaTag: "minicpm5:1b", hfPath: "openbmb/MiniCPM5-1B", quants: [{ name: "Q4_K_M", qualityBucket: "high", memoryGb: 1.0 }, { name: "Q5_K_M", qualityBucket: "high", memoryGb: 1.2 }, { name: "Q8_0", qualityBucket: "near-fp16", memoryGb: 1.6 }] },
  ...
  { id: "lfm2-5-2-6b", familyId: "lfm2-5", variant: "2.6B", paramBillions: 2.7, isMoE: false, useCase: { general: 6, code: 4, longContext: 6, math: 4 }, ollamaTag: "lfm2.5:2.6b", hfPath: "LiquidAI/LFM2.5-2.6B-GGUF", quants: [{ name: "Q4_K_M", qualityBucket: "high", memoryGb: 2.0 }, { name: "Q5_K_M", qualityBucket: "high", memoryGb: 2.3 }, { name: "Q8_0", qualityBucket: "near-fp16", memoryGb: 3.2 }], notes: "Convolution-attention hybrid for edge hardware. Liquid publishes its own GGUF files." },
